...
const SERVICE_TERMS: Record<string, string> = {
  ...
  'water-through-ceiling': 'water coming through ceiling leaking ceiling ceiling leak water through ceiling bulging ceiling wet ceiling stain ceiling drip flat above leak',
  'toilet-repair': 'toilet repair toilet not flushing toilet keeps running leaking toilet toilet leaking cistern flush button siphon fill valve toilet leak base concealed cistern',
  'leak-repair': 'leak repair water leak repair leaking pipe joint dripping pipe leaking valve radiator valve leak compression fitting washing machine hose leak overflow dripping',
